TITLE
    Ticket Volume Input (Edge Case, input too high)
DESCRIPTION
    ...
    enter a ticket price. Enter an integer value greater than 100 when prompted 
    to enter a ticket volume. Verify that the value is not accepted, and an 
    error occurs.
DEPENDENCIES
    sell_15
